...
('11111111-1111-4111-8111-111111111111','primo_colloquio','Primo colloquio','Accoglienza e orientamento','Un primo incontro per conoscerci, ascoltare la richiesta e capire insieme quale percorso può essere più adatto.',1,true),
...
('33333333-3333-4333-8333-333333333333','relazioni','Difficoltà Relazionali','Costruire legami autentici','Supporto per comprendere dinamiche di coppia, famiglia, amicizia e confini personali.',30,false),
('44444444-4444-4444-8444-444444444444','autostima','Autostima e Identità','Riscoprire il proprio valore','Percorsi per ridurre autocritica e perfezionismo e costruire una relazione più gentile con sé.',31,false),
('55555555-5555-4555-8555-555555555555','traumi','Elaborazione dei Traumi','Guarire dalle ferite del passato','Accompagnamento delicato per rielaborare esperienze traumatiche e lutti significativi.',32,false)
