...
insert into services (id, code, title, subtitle, description, content_type, display_order, active) values
('11111111-1111-4111-8111-111111111111','primo_colloquio','Primo colloquio','Accoglienza e orientamento','Un primo incontro per conoscerci, ascoltare la richiesta e capire insieme quale percorso può essere più adatto.','servizio',1,true),
('66666666-6666-4666-8666-666666666666','sostegno_psicologico','Sostegno psicologico','Uno spazio di ascolto','Percorsi di supporto per affrontare momenti di difficoltà, cambiamento, fatica emotiva o blocchi personali.','servizio',2,true),
('77777777-7777-4777-8777-777777777777','potenziamento_cognitivo','Potenziamento cognitivo','Risorse e strategie','Attività mirate per sostenere attenzione, memoria, funzioni esecutive e metodo di studio in modo graduale e personalizzato.','servizio',3,true),
('88888888-8888-4888-8888-888888888888','screening_dsa','Screening DSA','Valutazione iniziale','Screening per individuare possibili difficoltà specifiche dell’apprendimento e orientare eventuali approfondimenti diagnostici.','servizio',4,true),
('22222222-2222-4222-8222-222222222222','ansia','Ansia e stress','Regolazione emotiva','Supporto per riconoscere e gestire ansia, stress, tensione, preoccupazioni ricorrenti e sovraccarico quotidiano.','ambito',20,true),
('99999999-9999-4999-8999-999999999999','eta_evolutiva','Età evolutiva','Infanzia e adolescenza','Interventi rivolti a bambini e adolescenti per sostenere sviluppo emotivo, relazionale, scolastico e comportamentale.','ambito',21,true),
('aaaaaaaa-1111-4111-8111-aaaaaaaaaaaa','genitorialita','Genitorialità','Supporto ai genitori','Uno spazio per accompagnare i genitori nella comprensione dei bisogni dei figli e nella gestione delle sfide educative.','ambito',22,true),
('33333333-3333-4333-8333-333333333333','relazioni','Difficoltà Relazionali','Costruire legami autentici','Supporto per comprendere dinamiche di coppia, famiglia, amicizia e confini personali.','ambito',30,false),
('44444444-4444-4444-8444-444444444444','autostima','Autostima e Identità','Riscoprire il proprio valore','Percorsi per ridurre autocritica e perfezionismo e costruire una relazione più gentile con sé.','ambito',31,false),
('55555555-5555-4555-8555-555555555555','traumi','Elaborazione dei Traumi','Guarire dalle ferite del passato','Accompagnamento delicato per rielaborare esperienze traumatiche e lutti significativi.','ambito',32,false)
on conflict (code) do update set title=excluded.title, subtitle=excluded.subtitle, description=excluded.description, content_type=excluded.content_type, display_order=excluded.display_order, active=excluded.active;
